class ShoppingCartItemsController < ApplicationController
  ...
  def create
    @shopping_cart_item = @shopping_cart.add_product_item(params, @shopping_cart.id)

    respond_to do |format|
      if @shopping_cart_item.save
        format.html {redirect_to @shopping_cart_item.shopping_cart, notice: 'Item added to card'}
  ...
  def destroy
    ...
    respond_to do |format|
      format.html {redirect_to shopping_cart_path(@shopping_cart), notice: 'Shopping cart item was successfully destroyed.'}
